...
This is my personal project for implementation of an **AI-powered Data Discovery & SQL Generation Agent using AWS Quick Suite** leveraging the following key components:
